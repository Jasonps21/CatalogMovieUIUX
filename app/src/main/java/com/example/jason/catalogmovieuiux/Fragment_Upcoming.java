...
public class Fragment_Upcoming extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<MovieItems>>{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bundle.putString("kategori", MyAsyncTaskLoader.EXTRA_UP_COMING);
