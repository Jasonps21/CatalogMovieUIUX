...
public class ImageFavoriteWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.example.jason.catalogmovieuiux.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.jason.catalogmovieuiux.EXTRA_ITEM";
